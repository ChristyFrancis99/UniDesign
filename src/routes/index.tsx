...
function HomePage() {
  ...
  return <>
    ...
    <section className="content-shell grid gap-16 py-28 md:grid-cols-12 md:items-center"><div className="md:col-span-7"><img src={studioImage} width={1600} height={1104} loading="lazy" alt="UnI studio material table and design workspace" className="aspect-[4/3] w-full object-cover" /></div><div className="md:col-span-4 md:col-start-9"><p className="editorial-label text-gold">08 — About</p><h2 className="mt-7 display-lg">DESIGNING<br />WITH PURPOSE.</h2><p className="mt-7 leading-7 text-muted-foreground">UnI Design Group brings architecture, interior design and visualisation together to create considered spaces.</p><Button asChild variant="editorial" className="mt-8"><Link to="/about">Meet the studio →</Link></Button></div></section>

    <section className="bg-secondary py-28"><div className="content-shell grid gap-16 md:grid-cols-2 md:items-center"><img src={interiorImage} width={1408} height={1760} loading="lazy" alt="Editorial dining interior visual study" className="aspect-[4/5] w-full object-cover" /><div><p className="editorial-label text-gold">09 — The people</p><h2 className="mt-7 display-lg">THE PEOPLE<br />BEHIND THE<br />SPACES</h2><p className="mt-7 max-w-md text-muted-foreground">A studio working across architecture, interiors, visualisation and project coordination.</p><Button asChild variant="editorial" className="mt-8"><Link to="/about">Meet the team →</Link></Button></div></div></section>
